 ...
 */
public class WeatherSpeechletRequestStreamHandler extends SpeechletRequestStreamHandler {
    ...
    public WeatherSpeechletRequestStreamHandler() {
        super(new WeatherSpeechlet(), supportedApplicationIds);
    }

    public WeatherSpeechletRequestStreamHandler(Speechlet speechlet,
