 ...
 */
public class NewsHeadersSpeechletRequestStreamHandler extends SpeechletRequestStreamHandler {
...
//        supportedApplicationIds.add(appId);
    ...
    public NewsHeadersSpeechletRequestStreamHandler() {
        super(new NewsHeadersSpeechlet(), supportedApplicationIds);
    }

    public NewsHeadersSpeechletRequestStreamHandler(Speechlet speechlet,
